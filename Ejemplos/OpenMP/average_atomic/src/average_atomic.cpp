...
int main(int argc, char* argv[]) {
  ...
  // Suma los valores dentro de la variable
  // my_partial_sum
    ...
    // El atomic hace una funcion muy parecida al
    // mutex, la diferencia radica en que el atomic
    // no agarra muchos recursos y procesos, haciendolo
    // ideal para programas con pocos datos dentro de la
    // zona critica y faciles de analizar
    #pragma omp atomic
